...
export default function Contact() {
    ...
    return (
        ...
        >
            {deviceType === DeviceType.DESKTOP && (
                ...
                >
                    <svg viewBox="0 0 617.24 351">
                        ...
                        />
                        <path strokeWidth={1} fill={"rgba(255,255,255, 0.2)"} id="eye-circle-2"
            ...
            >
                <img id="eye-circle" height={deviceType === DeviceType.DESKTOP ? 120 : 125} ref={logoRef} alt={"logo"}
                     src={"/logo.png"}/>
            </Stack>
            <Grid
                p={"md"}
            ...
            >
                ...
                >
                    ...
                    <Text style={{color: "white"}}>FULL-TIME DEVELOPER</Text>
                    <Text style={{color: "white"}}>PART-TIME MOMENTS RECORDER</Text>
                    <br/>
